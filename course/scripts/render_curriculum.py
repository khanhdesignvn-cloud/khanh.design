...
OUTPUT = ROOT / "course" / "dist" / "04-09-2026-Giao-an-AI-Van-hanh-doanh-nghiep.pdf"
...
class CourseDoc(BaseDocTemplate):
    def __init__(self, filename: str, st: dict):
        super().__init__(filename, pagesize=A4, leftMargin=18 * mm, rightMargin=18 * mm, topMargin=18 * mm, bottomMargin=17 * mm, title="Giáo án AI Vận Hành Doanh Nghiệp", author="khanh.design")
    ...
    def draw_page(self, canvas, doc):
        ...
        canvas.drawString(18 * mm, 9 * mm, "AI VẬN HÀNH DOANH NGHIỆP · Giáo án giảng viên")
...
def build() -> Path:
    ...
    story = [
        Spacer(1, 45 * mm),
        Paragraph("GIÁO ÁN GIẢNG VIÊN", st["CoverTitle"]),
    ...
    sources = [SOURCE / "facilitator-guide.md"] + [SOURCE / f"week-{n:02d}.md" for n in range(1, 7)]
