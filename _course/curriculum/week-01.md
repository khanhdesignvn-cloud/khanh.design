...
**Sản phẩm tuần:** Bản đồ cơ hội AI đã chấm điểm cùng danh sách ba quy trình ưu tiên  
**Kết quả nối tiếp:** bản đồ cơ hội AI và ba quy trình ưu tiên.  
...
- Phân loại đúng ít nhất 8/10 tình huống thành nên giao AI, cần người duyệt hoặc không nên giao AI.
- Viết một bản giao việc có đủ mục tiêu, bối cảnh, đầu vào, đầu ra và tiêu chí thành công.
- Ẩn danh được dữ liệu nhận diện trong một tình huống khách hàng mẫu trước khi đưa vào Claude.
...
Doanh nghiệp mẫu Mộc Nhiên bán bộ quà trà 590.000 đồng; khách chính là quản lý 30–45 tuổi mua quà tri ân. Mục tiêu là bài Facebook 180–220 chữ, giọng điềm tĩnh, không hứa chữa bệnh, CTA nhắn tin để nhận bảng lựa chọn. Dữ liệu khách hàng dùng mã KH-001, không có tên hay số điện thoại.
...
**Tên demo:** Biến yêu cầu mơ hồ “viết bài bán khóa học” thành brief có tiêu chí.

1. Chiếu yêu cầu mơ hồ và mời lớp dự đoán ba loại lỗi có thể xảy ra.
2. Bổ sung lần lượt mục tiêu, bối cảnh, dữ liệu nguồn, định dạng đầu ra và tiêu chí đạt.
3. Yêu cầu Claude tự kiểm theo checklist rồi chỉ ra điểm chưa chắc chắn.
4. So sánh hai đầu ra, đánh dấu câu không có căn cứ và sửa brief.
...
1. Liệt kê 10 công việc lặp lại trong một tuần làm việc thật.
2. Chấm mỗi việc theo tần suất, thời gian, độ chuẩn hóa, rủi ro và nhu cầu phán đoán.
3. Chọn một việc điểm cao nhưng rủi ro thấp; viết bản giao việc năm thành phần.
4. Đổi bài theo cặp và dùng checklist để tìm chỗ thiếu, sau đó sửa một vòng.
...
|---|---|---|
| Có ít nhất 8 công việc cụ thể, viết bằng động từ và có đầu ra quan sát được. | Có bằng chứng rõ, dùng được ngay và không vi phạm ranh giới an toàn. | Thiếu bằng chứng, còn suy đoán hoặc chưa có bước duyệt. |
| Ba ưu tiên có lý do dựa trên điểm số, không chỉ dựa trên cảm tính. | Có bằng chứng rõ, dùng được ngay và không vi phạm ranh giới an toàn. | Thiếu bằng chứng, còn suy đoán hoặc chưa có bước duyệt. |
| Bản giao việc đủ mục tiêu, bối cảnh, đầu vào, định dạng và tiêu chí đánh giá. | Có bằng chứng rõ, dùng được ngay và không vi phạm ranh giới an toàn. | Thiếu bằng chứng, còn suy đoán hoặc chưa có bước duyệt. |
| Dữ liệu mẫu đã ẩn danh và có bước người chịu trách nhiệm duyệt. | Có bằng chứng rõ, dùng được ngay và không vi phạm ranh giới an toàn. | Thiếu bằng chứng, còn suy đoán hoặc chưa có bước duyệt. |
...
Hoàn thiện bản đồ 10 công việc; chạy thử một bản giao việc hai lần với cùng dữ liệu mẫu; lưu đầu ra, thời gian trước/sau và ba chỉnh sửa cần thiết.
...
- Không nhập tên, số điện thoại, email, địa chỉ, mã hợp đồng hoặc thông tin thanh toán thật.
- Không tải tài liệu nội bộ khi chưa biết quyền chia sẻ và thời hạn lưu giữ.
- Thay dữ liệu thật bằng mã giả; giữ bảng ánh xạ ở hệ thống nội bộ, không đưa vào AI.
...
- Viết prompt dài nhưng không có tiêu chí đạt.
- Chọn việc có hậu quả cao như phê duyệt thanh toán để tự động hóa đầu tiên.
- Tin câu trả lời trôi chảy thay cho kiểm tra nguồn.
